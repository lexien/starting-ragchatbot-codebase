...
class CourseOutlineTool(Tool):
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        return {
            ...
            "description": "Get the full outline of a course: its title, course link, and a numbered list of lessons with their titles. Use this for questions about what a course covers, its structure, or its lesson list.",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_name": {
